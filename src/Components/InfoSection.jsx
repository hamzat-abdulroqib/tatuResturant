...
const InfoSection = () => {
  return (
    <section
      className="w-full bg-white px-4 sm:px-8 py-10 sm:py-16 font-serif 
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-5 space-y-4 text-sm text-gray-600">
              <div className="flex flex-col sm:flex-row sm:justify-between">
                ...
                <span className="mt-1 sm:mt-0 text-gray-600">
                  12.00 PM - 3.00 PM / 6.00 PM - 10.00 PM
                </span>
              </div>

              <div className="flex flex-col sm:flex-row sm:justify-between">
                <span className="font-semibold text-gray-800">SATURDAYS</span>
                <span className="mt-1 sm:mt-0 text-gray-600">
                  6.00 PM - 10.00 PM
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between">
                <span className="font-semibold text-gray-800">SUNDAYS</span>
                <span className="mt-1 sm:mt-0 text-gray-600">Closed</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-5 flex text-sm">
                ...
                <div className="flex w-full flex-col sm:flex-row sm:justify-between">
                  ...
                  <a
                    href="tel:0795737786"
                    className="text-gray-800 hover:underline sm:text-right"
                  >
                    0795 737 786
                  </a>
                </div>
              ...
              <div className="mt-4 flex text-sm">
                ...
                <div className="flex w-full flex-col sm:flex-row sm:justify-between">
                  ...
                  <a
                    ...
                    className="break-all text-gray-800 hover:underline sm:break-normal sm:text-right"
                  >
