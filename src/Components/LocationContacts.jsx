        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="md:col-span-1">
            <h2 className="text-3xl md:text-4xl text-gray-900">
              Location{" "}
              <span className="italic font-['Playfair_Display']">&</span>{" "}
              Contact
            </h2>
          </div>
          ...
          <div className="md:col-span-2 md:border-l md:border-gray-200 md:pl-12">
            <div className="flex flex-col space-y-10">
              ...
              <div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between text-sm mt-5">
