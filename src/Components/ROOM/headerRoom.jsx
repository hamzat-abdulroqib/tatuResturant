      ...
      <section className="w-full px-4 py-12 md:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-12 font-serif text-4xl text-gray-900 md:text-5xl">
            Unparalleled{" "}
            <span className="italic font-['Playfair_Display']">luxury</span> at
            Fairmont The Norfolk
          </h2>

          {/* Paragraph */}
          <p className="mx-auto mt-6 max-w-3xl text-base leading-relaxed text-gray-600 md:text-lg">
            Our 108 rooms and 17 suites are designed to provide the utmost
            comfort and sophistication. They feature stylish interiors, premium
            bath products that ensure a rejuvenating experience, upgraded rooms
            and sophisticated suites. Our suites offer a separate living area
            and are embellished with touches of colonial grandeur, providing a
            truly unique and luxurious stay.
          </p>
        </div>
      </section>
    </div>
